...
sleep 0.3
screen -S ModemQuec -X stuff 'AT+QCFG="BAND",0,85,85,1\r'
screen -S ModemQuec -X stuff 'AT+QCFG="BAND"\r'

sleep 0.3
screen -S ModemQuec -X stuff 'AT+QCFG="iotopmode",0,1\r'
sleep 0.3
screen -S ModemQuec -X stuff 'AT+QCFG="nwscanseq",020301,1\r'
screen -S ModemQuec -X stuff 'AT+QCFG="nwscanseq"\r'

sleep 0.3
screen -S ModemQuec -X stuff 'AT+QCFG="nwscanmode",3,1\r'
sleep 0.3
...
/usr/local/bin/quectel-CM -f /root/cm.log
